...
public struct HBCookie: Sendable, CustomStringConvertible {
    ...
    public var expires: Date? { return self.properties[.expires].map { DateFormatter.rfc1123.date(from: $0) } ?? nil }
    ...
    public init(
        ...
        properties[.expires] = expires.map { DateFormatter.rfc1123.string(from: $0) }
