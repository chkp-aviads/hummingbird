...
final class HTTP2ServerConnectionManager: ChannelDuplexHandler {
    ...
    init(
        ...
        maxAgeTimeout: TimeAmount?,
        gracefulCloseTimeout: TimeAmount?
    ) {
        ...
        self.maxAgeTimer = maxAgeTimeout.map { Timer(delay: $0) }
        self.gracefulCloseTimer = gracefulCloseTimeout.map { Timer(delay: $0) }
    }
